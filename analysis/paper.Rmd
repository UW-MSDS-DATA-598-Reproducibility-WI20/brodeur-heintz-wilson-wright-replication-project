...
The R function cor.test() was used to get the Pearson correlation coefficient between the different independent variables (income, age, sex, white, married) and happiness. Grundberg et al.'s code was slightly modified to keep the same encoding of variables given the new dataset input.
